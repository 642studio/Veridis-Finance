...
function normalizeImportedTransaction(transaction, fallbackBank) {
  ...
  return {
    ...
    clean_concept: trimLength(transaction?.clean_concept, 160) || null,
    counterparty_name: trimLength(transaction?.counterparty_name, 160) || null,
    counterparty_rfc: trimLength(transaction?.counterparty_rfc, 20) || null,
    ...
    for (
      ...
      const insertTransactionQuery = {
        ...
        values: [
          ...
          normalized.amount,
          normalized.category,
          normalized.clean_concept || normalized.raw_description,
          resolvedEntityName || normalized.counterparty_name,
